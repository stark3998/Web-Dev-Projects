...
foreach($images as $image) {
    echo '<tr><td>'.$i++.'</td><td><img src="'.$image.'" style="width:100px"/></td><td>
    '.basename($image).PHP_EOL.'</td><td>'.pathinfo($image, PATHINFO_EXTENSION).'</td><td><span class="glyphicon glyphicon-trash"></span></td><br /></tr>';
}
?>
</tbody>
          </div>
